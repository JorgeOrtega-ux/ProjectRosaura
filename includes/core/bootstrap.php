...
header("Content-Security-Policy: default-src 'self'; script-src 'self' 'unsafe-inline' https://unpkg.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' data: blob: https://fonts.gstatic.com https://api.qrserver.com; img-src 'self' data: blob: https://api.qrserver.com; media-src 'self' blob:; worker-src 'self' blob:; connect-src 'self' https://unpkg.com ws: wss:; frame-ancestors 'none';");require_once ROOT_PATH . '/vendor/autoload.php';
