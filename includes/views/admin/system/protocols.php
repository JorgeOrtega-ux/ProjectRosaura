...
// 2. Configurar clases y variables dinámicas según el estado (sin estilos en línea)
...
$panicBtnClass = $isPanicModeActive ? 'component-button--danger' : 'component-button--secondary';
    ...
    <div class="component-viewport">
        <div class="component-wrapper">
            <div class="component-bottom">
                    ...
                    <div class="component-group-item">
                        <div class="component-card__content">
                            <div class="component-card__icon-container component-card__icon-container--bordered">
                                <span class="material-symbols-rounded"><?php echo $panicStatusIcon; ?></span>
                            </div>
                ...
                <div class="component-card--grouped component-accordion" data-ref="admin-protocols-group">
                    <div class="component-group-item component-group-item--wrap component-accordion-header" data-action="toggleAccordion">
                        <div class="component-card__content">
                            ...
                            <div class="component-card__text">
                                <h2 class="component-card__title"><?php echo __('admin_maintenance_title_main'); ?></h2>
                                <p class="component-card__description"><?php echo __('admin_maintenance_desc_main'); ?></p>
                            </div>
                        </div>
