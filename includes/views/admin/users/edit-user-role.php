                        ...
                        <div class="component-group-item component-group-item--wrap component-accordion-header" data-action="toggleAccordion">
                            <div class="component-card__content">
                                ...
                                <div class="component-card__text">
                                    <h2 class="component-card__title">Gestión de Roles de Usuario</h2>
                                    <p class="component-card__description">Asigna o revoca los roles de acceso y jerarquía de permisos del usuario en la plataforma</p>
                                </div>
                            </div>
                                    ...
                                    <div class="component-card__content">
                                        <div class="component-card__text">
                                            <h2 class="component-card__title">
                                                ...
                                                <?php if($r['id'] == 1): ?> 
                                                    <span class="component-badge component-badge--sm"><span class="material-symbols-rounded">lock</span> <?php echo __('lbl_base_role'); ?></span> 
                                                <?php endif; ?>
