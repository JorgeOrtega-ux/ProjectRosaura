...
$userPurchasesData = $adminService->getUserPurchasesData($_GET['uuid'] ?? '', $page);

if (!empty($userPurchasesData['redirect'])) {
    header("Location: " . $userPurchasesData['redirect']);
    exit;
}

extract($userPurchasesData);
$user = $targetUser;
$appUrl = defined('APP_URL') ? APP_URL : '';
?>

<div class="view-content" data-user-id="<?php echo $targetUserId; ?>" data-user-uuid="<?php echo htmlspecialchars($user['uuid']); ?>">
    <div class="component-wrapper component-wrapper--full no-padding" data-ref="admin-user-purchases-wrapper">
        
        <div class="component-top">
            <div class="component-top-left">
                <h1 class="component-top-title"><?php echo __('admin_user_purchases_title'); ?>: <?php echo htmlspecialchars($user['username']); ?></h1>
            </div>
            ...
            <div class="component-top-right">
                        ...
                        <div class="component-module component-module--dropdown component-module--dropdown-fixed component-module--spaced disabled" data-module="modulePurchaseFilters">
                            ...
                            <div class="component-menu component-menu--w265 component-menu--h-auto component-menu--no-padding disabled" data-ref="menuFilterStatus">
                                ...
                                <div class="component-menu-list component-menu-list--scrollable component-menu-list--compact">
                                    ...
                                    <label class="component-menu-link component-menu-link--bordered">
                                        <div class="component-menu-link-icon"><input class="filter-checkbox" data-filter-type="status" data-value="succeeded" type="checkbox" value="succeeded" checked></div>
                                        <div class="component-menu-link-text"><span><?php echo __('lbl_paid'); ?></span></div>
                                    </label>
                                    <label class="component-menu-link component-menu-link--bordered">
                                        <div class="component-menu-link-icon"><input class="filter-checkbox" data-filter-type="status" data-value="failed" type="checkbox" value="failed" checked></div>
                ...
                <div class="component-actions disabled" data-ref="header-selection-actions">
                    <button class="component-button component-button--icon component-button--h40" data-action="downloadReceipt" data-tooltip="<?php echo __('tooltip_download_receipt'); ?>" data-position="bottom">
                        <span class="material-symbols-rounded">download</span>
                    </button>
                    <button class="component-button component-button--icon component-button--h40" data-action="deselectPurchase" data-tooltip="<?php echo __('btn_close'); ?>" data-position="bottom">
