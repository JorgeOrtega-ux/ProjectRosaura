...
CREATE TABLE IF NOT EXISTS `support_tickets` (
  ...
  UNIQUE KEY `idx_support_tickets_tracking_code` (`tracking_code`),
...
INSERT IGNORE INTO `support_canned_responses` (`id`, `uuid`, `shortcut`, `title`, `content`, `category`, `language`, `min_level`) VALUES
  ...
  (1, UUID(), 'saludo', 'Saludo Inicial de Soporte', '¡Hola {client_name}! Mi nombre es {agent_name} del equipo de soporte técnico de Rosaura. ¿En qué podemos colaborarte hoy?', 'general', 'es-419', 'l1'),
  ...
  (3, UUID(), 'escalar_l2', 'Aviso de Transferencia Especializada', 'He verificado tu caso, {client_name}. Para brindarte una solución más ágil lo he transferido a un Especialista de Nivel 2. Por favor mantente en línea mientras revisamos tu expediente.', 'technical', 'es-419', 'l1'),
  ...
  (5, UUID(), 'despedida', 'Despedida y Cierre', 'Ha sido un placer ayudarte hoy. Te atendió {agent_name}. Si tienes alguna otra duda o consulta adicional no dudes en escribirnos nuevamente. ¡Que tengas un excelente día!', 'general', 'es-419', 'l1'),

  -- Español (México)
  (6, UUID(), 'saludo', 'Saludo Inicial de Soporte', '¡Hola {client_name}! Te atiende {agent_name} del equipo de soporte técnico de Rosaura. ¿En qué te podemos ayudar hoy?', 'general', 'es-MX', 'l1'),
  ...
  (8, UUID(), 'escalar_l2', 'Aviso de Transferencia Especializada', 'Revisé tu caso, {client_name}, y para darte una solución rápida lo transferí con un Especialista de Nivel 2. Por favor mantente en línea mientras lo revisamos.', 'technical', 'es-MX', 'l1'),
  ...
  (10, UUID(), 'despedida', 'Despedida y Cierre', 'Fue un gusto atenderte. Te atendió {agent_name}. Si tienes más dudas estamos para servirte. ¡Que tengas un excelente día!', 'general', 'es-MX', 'l1'),

  -- Español (España)
  (11, UUID(), 'saludo', 'Saludo Inicial de Soporte', '¡Hola {client_name}! Mi nombre es {agent_name}, del equipo de soporte técnico de Rosaura. ¿En qué te podemos ayudar hoy?', 'general', 'es-ES', 'l1'),
  ...
  (15, UUID(), 'despedida', 'Despedida y Cierre', 'Ha sido un placer ayudarte. Te ha atendido {agent_name}. Si necesitas cualquier otra cosa, no dudes en escribirnos de nuevo. ¡Un saludo cordial!', 'general', 'es-ES', 'l1'),

  -- English (United States)
  (16, UUID(), 'greeting', 'Initial Support Greeting', 'Hello {client_name}! My name is {agent_name} from the Rosaura technical support team. How may we assist you today?', 'general', 'en-US', 'l1'),
  ...
  (18, UUID(), 'escalate_l2', 'Transfer to Tier 2 Support', 'I have reviewed your case, {client_name}, and transferred it to a Tier 2 Support Specialist for faster resolution. Please stay on the line while we review your details.', 'technical', 'en-US', 'l1'),
  ...
  (20, UUID(), 'farewell', 'Farewell and Closure', 'It has been a pleasure assisting you today. You were assisted by {agent_name}. If you have any further questions, please do not hesitate to contact us again. Have a great day!', 'general', 'en-US', 'l1'),

  -- English (United Kingdom)
  (21, UUID(), 'greeting', 'Initial Support Greeting', 'Hello {client_name}! My name is {agent_name} from Rosaura technical support. How may we help you today?', 'general', 'en-GB', 'l1'),
  ...
  (25, UUID(), 'farewell', 'Farewell and Closure', 'It has been our pleasure to assist you today. You were assisted by {agent_name}. If you require further assistance, please feel free to reach out. Have a wonderful day!', 'general', 'en-GB', 'l1'),

  -- Français (France)
  (26, UUID(), 'salutation', 'Salutation Initiale du Support', 'Bonjour {client_name} ! Je m''appelle {agent_name} du support technique de Rosaura. Comment pouvons-nous vous aider aujourd''hui ?', 'general', 'fr-FR', 'l1'),
  ...
  (30, UUID(), 'remerciement', 'Clôture et Remerciement', 'Ce fut un plaisir de vous aider aujourd''hui. Vous avez été assisté par {agent_name}. Si vous avez d''autres questions, n''hésitez pas à nous recontacter. Excellente journée à vous !', 'general', 'fr-FR', 'l1'),

  -- Deutsch (Deutschland)
  (31, UUID(), 'begruessung', 'Support-Begrüßung', 'Hallo {client_name}! Mein Name ist {agent_name} vom technischen Support von Rosaura. Wie können wir Ihnen heute helfen?', 'general', 'de-DE', 'l1'),
  ...
  (35, UUID(), 'verabschiedung', 'Abschluss und Verabschiedung', 'Es war uns ein Vergnügen, Ihnen zu helfen. Sie wurden von {agent_name} betreut. Bei weiteren Fragen stehen wir Ihnen gerne zur Verfügung. Einen schönen Tag noch!', 'general', 'de-DE', 'l1'),

  -- Italiano (Italia)
  (36, UUID(), 'saluto', 'Saluto Iniziale Supporto', 'Ciao {client_name}! Sono {agent_name} dell''assistenza tecnica di Rosaura. Come possiamo aiutarti oggi?', 'general', 'it-IT', 'l1'),
  ...
  (40, UUID(), 'congedo', 'Chiusura e Saluti', 'È stato un piacere aiutarti. Sei stato assistito da {agent_name}. Se hai altre domande, non esitare a contattarci di nuevo. Buona giornata!', 'general', 'it-IT', 'l1'),

  -- Português (Brasil)
  (41, UUID(), 'saudacao', 'Saudação Inicial de Suporte', 'Olá {client_name}! Meu nome é {agent_name}, do suporte técnico da Rosaura. Como podemos ajudar você hoje?', 'general', 'pt-BR', 'l1'),
  ...
  (45, UUID(), 'despedida', 'Encerramento e Despedida', 'Foi um prazer ajudar você! Você foi atendido por {agent_name}. Se tiver qualquer outra dúvida, fique à vontade para nos chamar novamente. Tenha um excelente dia!', 'general', 'pt-BR', 'l1'),

  -- Português (Portugal)
  (46, UUID(), 'saudacao', 'Saudação Inicial de Suporte', 'Olá {client_name}! O meu nome é {agent_name}, do suporte técnico da Rosaura. Em que lhe podemos ser úteis hoje?', 'general', 'pt-PT', 'l1'),
  ...
  (50, UUID(), 'escalar_n3', 'Transferência para Engenharia (Nível 3)', 'O seu caso foi escalado para a equipa de Engenharia e Supervisão (Nível 3). Estamos a averiguar a anomalia no servidor.', 'technical', 'pt-PT', 'l2'),
  (50, UUID(), 'despedida', 'Encerramento e Despedida', 'Foi um gosto prestar-lhe assistência. Foi atendido por {agent_name}. Se necessitar de mais algum esclarecimento, não hesite em contactar-nos. Tenha um ótimo dia!', 'general', 'pt-PT', 'l1');

-- --------------------------------------------------------
-- Permissions for application user
-- --------------------------------------------------------
GRANT ALL PRIVILEGES ON db_support.* TO 'system_web_executor'@'%';
FLUSH PRIVILEGES;
