...
export class AdminDashboardController {
    ...
    async init() {
        ...
        // Realizar la petición de datos directamente
    ...
    async fetchAndRenderData() {
        // Al enviar null en los parámetros, la API devolverá automáticamente la información 
        // de los últimos 30 días calculada desde el servidor.
