    ...
    <div class="component-wrapper component-wrapper--full no-padding">
        ...
        <div class="component-top">
            <div class="component-top-left">
                <h1 class="component-top-title">Tienda de Ventajas (Contenido)</h1>
            </div>
            <div class="component-top-right">
                <div class="component-actions disabled" data-ref="perk-selection-actions">
                    <?php if ($canManageStore): ?>
                    <button class="component-button component-button--secondary component-button--icon component-button--h40" data-action="editPerk" data-tooltip="<?php echo __('btn_edit'); ?>" data-position="bottom">
                        <span class="material-symbols-rounded">edit</span>
                    </button>
                    <button class="component-button component-button--secondary component-button--icon component-button--h40" data-action="toggleVisibilityPerk" data-tooltip="<?php echo __('btn_toggle_visibility'); ?>" data-position="bottom">
                        <span class="material-symbols-rounded">visibility</span>
                    </button>
                    <button class="component-button component-button--danger component-button--icon component-button--h40" data-action="deletePerk" data-tooltip="<?php echo __('btn_delete'); ?>" data-position="bottom">
                ...
                <div class="component-actions active" data-ref="header-default-actions">
                    ...
                    <?php if ($canManageStore): ?>
                    <button class="component-button component-button--primary component-button--icon component-button--h40" data-action="addPerk" data-tooltip="Nueva Ventaja" data-position="bottom">
            ...
            <div class="component-search-toolbar disabled" data-ref="search-toolbar">
                <div class="component-search">
                    ...
                    <div class="component-search-input">
                        <input type="text" data-ref="perk-search-input" placeholder="Buscar ventaja..." value="<?php echo htmlspecialchars($searchQuery); ?>">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="component-bottom">
            ...
            <div class="component-table-wrapper" data-ref="perks-table-wrapper">
                <table class="component-table">
                    <thead>
                        <tr>
                            <th>Nombre de la Ventaja</th>
                            <th>Identificador (Perk ID)</th>
                            <th data-width="120">Precio (Monedas)</th>
            ...
            <div class="component-empty-state" data-ref="perks-empty-state">
                ...
                <h3>No hay ventajas configuradas</h3>
                <p>Crea la primera ventaja para tu tienda.</p>
            </div>
            <?php endif; ?>
        </div>
