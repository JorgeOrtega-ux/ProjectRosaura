...
return [
    ...
    '/@:identifier' => ['view' => 'user/profile.php'],
    '/publication/:id' => ['view' => 'canvases/publications/publication-viewer.php'],
    '/publications/view/:id' => ['view' => 'canvases/publications/publication-viewer.php'],
