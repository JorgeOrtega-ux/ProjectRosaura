    ...
    <div class="component-about-layout">
        ...
        <div class="component-about-main">
            ...
            <div class="component-about-card">
                <p class="component-about-text component-about-subtitle"><strong>Acerca de <?php echo htmlspecialchars($displayName); ?></strong></p>
            ...
            <div class="component-about-details-grid">
                ...
                if (!$hasAnyDetail): ?>
                    <div class="component-about-card component-empty-state component-about-empty-state">
        ...
        <div class="component-about-sidebar">
            ...
            <div class="component-about-card">
                <ul class="component-about-list">
                    ...
                    <li class="component-about-list-item" id="channel-ranking-container" data-user-id="<?php echo isset($channelUser['id']) ? $channelUser['id'] : ''; ?>" style="display: none;">
                        <span class="material-symbols-rounded component-about-list-icon">military_tech</span>
                        <span id="channel-ranking-text">Posición #--</span>
                    </li>
                </ul>
            </div>
            ...
            <?php if (!empty($channelContact)): ?>
                ...
                <div class="component-about-card">
                    ...
                    <div class="component-about-contact-box">
                        <span class="material-symbols-rounded component-about-list-icon component-about-contact-icon">mail</span>
                        <a href="mailto:<?php echo htmlspecialchars($channelContact); ?>" class="component-about-contact-link"><?php echo htmlspecialchars($channelContact); ?></a>
                    </div>
                </div>
            <?php endif; ?>
