...
$proMonthly   = number_format($prices[1]['monthly'], 2);
$proYearly    = number_format($prices[1]['yearly'] / 12, 2);
$ultraMonthly = number_format($prices[2]['monthly'], 2);
$ultraYearly  = number_format($prices[2]['yearly'] / 12, 2);
    ...
    <div class="component-viewport">
        <div class="component-wrapper component-wrapper--full">
            <div class="component-bottom">
                ...
                <!-- Contenedor Flex de 3 Tarjetas -->
                <div class="component-flex-center-gap">
                    
                    <!-- Tarjeta 1: Plus (Gratuito / Inicial) -->
                    <div class="component-card component-plan-card component-card--grouped component-card--p18 component-card--w560 component-card--flow-top component-card--fw500" data-tier="0" data-ref="plan-card">
                        ...
                        <div class="component-plan-card__body">
                            <div class="component-plan-card__price-section">
                                <div class="component-plan-card__old-price">&nbsp;</div>
                                
                                <div class="component-plan-card__price-row">
                                    <span class="component-plan-card__price-amount">USD 0.00</span>
                                    <span class="component-plan-card__period"><?php echo __('premium_period_month'); ?></span>
                                </div>

                                <div class="component-plan-card__price-subtext">Incluido por defecto</div>
                            </div>
                            ...
                            <div class="component-plan-card__action">
                                ...
                                <?php else: ?>
                                    <div class="component-button component-button--dark component-button--rounded-pill component-button--full component-button--h40 component-cursor-pointer component-text-center" data-action="subscribe" data-tier="0"><?php echo __('premium_btn_downgrade_plus'); ?></div>
                                <?php endif; ?>
                            </div>
                        </div>
                            ...
                            <ul class="component-plan-card__features-list">
                                <li class="component-plan-card__feature-item">
                                    ...
                                    <div class="component-plan-card__feature-text">
                                        ...
                                        <span class="component-plan-card__feature-desc">Lienzo individual para proyectos personales.</span>
                                    </div>
                                </li>
                                <li class="component-plan-card__feature-item">
                                    <span class="material-symbols-rounded component-icon-sm component-plan-card__feature-icon">check</span>
                                    <div class="component-plan-card__feature-text">
                                        ...
                                        <span class="component-plan-card__feature-desc">Colaboración básica en tiempo real.</span>
                                    </div>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="component-card component-plan-card component-card--grouped component-card--p18 component-card--w560 component-card--flow-top component-card--fw500 component-card--featured" data-tier="1" data-ref="plan-card">
                        ...
                        <div class="component-plan-card__body">
                            ...
                            <div class="component-plan-card__action">
                                <?php if ($tier === 1): ?>
                                    <div class="component-button component-button--dark component-button--rounded-pill component-button--full component-button--h40 disabled-interactive component-cursor-pointer component-text-center"><?php echo __('premium_btn_current'); ?></div>
                                <?php elseif (1 < $tier): ?>
                                    <div class="component-button component-button--dark component-button--rounded-pill component-button--full component-button--h40 component-cursor-pointer component-text-center" data-action="subscribe" data-tier="1"><?php echo __('premium_btn_downgrade_pro'); ?></div>
                                <?php else: ?>
                                    <div class="component-button component-button--dark component-button--rounded-pill component-button--full component-button--h40 component-cursor-pointer component-text-center" data-action="subscribe" data-tier="1"><?php echo __('premium_btn_upgrade_pro'); ?></div>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="component-plan-card__footer">
                            <ul class="component-plan-card__features-list">
                                ...
                                <li class="component-plan-card__feature-item">
                                    ...
                                    <div class="component-plan-card__feature-text">
                                        ...
                                        <span class="component-plan-card__feature-desc">Colaboración fluida en tiempo real para equipos.</span>
                                    </div>
                                </li>
                            </ul>
                            ...
                            <ul class="component-plan-card__features-list">
                                <li class="component-plan-card__feature-item">
                                    <span class="material-symbols-rounded component-icon-sm component-text-secondary component-plan-card__feature-icon">movie</span>
                                    <div class="component-plan-card__feature-text">
                                        <span class="component-plan-card__feature-name"><?php echo __('premium_card_live_share'); ?></span>
                                        <span class="component-plan-card__feature-desc">Comparte plantillas directamente en el lienzo.</span>
                                    </div>
                                </li>
                                <li class="component-plan-card__feature-item">
                                    ...
                                    <div class="component-plan-card__feature-text">
                                        <span class="component-plan-card__feature-name"><?php echo __('premium_card_palettes_extended'); ?></span>
                                        <span class="component-plan-card__feature-desc">Acceso a paletas de colores profesionales.</span>
                                    </div>
                                </li>
                                <li class="component-plan-card__feature-item">
                                    ...
                                    <div class="component-plan-card__feature-text">
                                        ...
                                        <span class="component-plan-card__feature-desc">Guarda hasta <?php echo $tierPro['max_snapshots_per_canvas']; ?> versiones de historial.</span>
                                    </div>
                                </li>
                            </ul>
                        </div>
                    ...
                    <!-- Tarjeta 3: Ultra (Máximo Nivel) -->
                    <div class="component-card component-plan-card component-card--grouped component-card--p18 component-card--w560 component-card--flow-top component-card--fw500" data-tier="2" data-ref="plan-card">
                        ...
                        <div class="component-plan-card__body">
                            ...
                            <div class="component-plan-card__action">
                                <?php if ($tier === 2): ?>
                                    <div class="component-button component-button--dark component-button--rounded-pill component-button--full component-button--h40 disabled-interactive component-cursor-pointer component-text-center"><?php echo __('premium_btn_current'); ?></div>
                                <?php else: ?>
                                    <div class="component-button component-button--dark component-button--rounded-pill component-button--full component-button--h40 component-cursor-pointer component-text-center" data-action="subscribe" data-tier="2"><?php echo __('premium_btn_upgrade_ultra'); ?></div>
                                <?php endif; ?>
                            </div>
                        </div>
                            ...
                            <ul class="component-plan-card__features-list">
                                <li class="component-plan-card__feature-item">
                                    ...
                                    <div class="component-plan-card__feature-text">
                                        ...
                                        <span class="component-plan-card__feature-desc">Capacidad máxima para grandes organizaciones.</span>
                                    </div>
                                </li>
                                <li class="component-plan-card__feature-item">
                                    <span class="material-symbols-rounded component-icon-sm component-plan-card__feature-icon">check</span>
                            ...
                            <ul class="component-plan-card__features-list">
                                <li class="component-plan-card__feature-item">
                                    ...
                                    <div class="component-plan-card__feature-text">
                                        ...
                                        <span class="component-plan-card__feature-desc">Crea hasta <?php echo $tierUltra['max_custom_palettes']; ?> paletas de colores personalizadas.</span>
                                    </div>
                                </li>
                                <li class="component-plan-card__feature-item">
