...
<div class="view-content">
    ...
    <div class="component-wrapper">
        ...
        <div class="component-sticky-toolbar">
            <div class="component-toolbar-primary">
                <div class="component-toolbar-mode active">
                    <div class="component-toolbar-left" style="gap: 12px; display: flex; width: 100%;">
                        <button class="component-button component-button--h36 active" data-action="switchTab" data-target="view-status-config" id="tab-btn-config" style="flex: 1;">
                            <span class="material-symbols-rounded">toggle_on</span> <?php echo __('admin_status_tab_config', ['default' => 'Configurar estado']); ?>
                        </button>
                        <button class="component-button component-button--h36" data-action="switchTab" data-target="view-status-kardex" id="tab-btn-kardex" style="flex: 1; background: transparent; border-color: transparent;">
                            <span class="material-symbols-rounded">history</span> <?php echo __('admin_status_tab_kardex', ['default' => 'Kardex y Notas']); ?>
                        </button>
                    </div>
                </div>
            </div>
            <div class="component-toolbar-primary" id="toolbar-actions-config" style="border-top: 1px solid var(--border-lighter); margin-top: 8px; padding-top: 8px; justify-content: flex-end;">
                <button id="admin-btn-save-status" class="component-button component-button--h36 component-button--dark disabled-interaction" data-action="submitStatusUpdate">Guardar cambios de estado</button>
            </div>
        </div>

        <div class="component-header-card">
            <h1 class="component-page-title" id="page-main-title">Gestionar Estado</h1>
            <p class="component-page-description" id="page-main-desc">Administra el ciclo de vida y bloqueos independientes de la cuenta.</p>
        </div>
        ...
        <div id="admin-status-form" class="disabled">
            ...
            <div id="view-status-kardex" class="disabled">
                    ...
                    <div class="component-group-item component-group-item--stacked">
                        <div class="component-card__content component-card__content--full">
                            <div class="component-card__text">
                                ...
                                <div class="component-card__form-area">
                                    <textarea id="inp_new_admin_note" class="component-input-field" placeholder="Escribe tu nota aquí..." style="border: 1px solid var(--border-color); border-radius: 8px; resize: vertical; min-height: 80px; padding-top: 12px;"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="component-card__actions component-card__actions--end" style="width: 100%; justify-content: flex-end; margin-top: 8px;">
                            <button class="component-button component-button--h36 component-button--dark" data-action="submitAdminNote" id="btn-submit-note"><?php echo __('btn_add_note', ['default' => 'Guardar nota']); ?></button>
                        </div>
                    </div>
                </div>

                <div id="kardex-list-container" style="margin-top: 24px; display: flex; flex-direction: column; gap: 16px;">
                    </div>
