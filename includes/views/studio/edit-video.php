            ...
            <div class="component-view-top">
                ...
                <div class="component-view-top-right">
                    <button type="button" class="component-button component-button--dark component-button--h36" id="btnSaveChanges">
                        ...
                        <span><?php echo __('studio_btn_save_changes'); ?></span>
                    </button>
                </div>
            </div>
                                ...
                                <div class="component-card__content component-card__content--full">
                                    <div class="component-card__text">
                                        ...
                                        <div class="component-card__form-area">
                                            <textarea id="videoDescriptionInput" class="component-input-field" placeholder="<?php echo __('studio_video_desc_placeholder'); ?>" maxlength="1000" rows="5"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="studio-uploading-preview">
                        <div class="studio-video-card">
                            <div class="studio-video-card__player studio-video-card__player-preview">
                                <img id="dynamicThumbPreview" src="" alt="<?php echo __('studio_thumb_alt'); ?>" class="studio-video-card__player-img" onerror="if(!this.dataset.retried) { this.dataset.retried = 'true'; this.src = this.src.replace('/public/storage/', '/storage/'); } else { this.style.display='none'; if(this.nextElementSibling) { this.nextElementSibling.style.display='block'; } }">
                        ...
                        <div class="component-thumbnail-section">
                            ...
                            <div class="component-thumbnail-actions">
                                ...
                                <button type="button" class="component-button component-button--h40" onclick="document.getElementById('thumbnailInput').click();">
                                    ...
                                    <span><?php echo __('studio_thumb_upload_change'); ?></span>
                                </button>
