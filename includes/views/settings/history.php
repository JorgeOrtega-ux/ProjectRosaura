...
<div class="view-content view-content--history">
    <div class="component-wrapper">
        ...
        <div class="component-header-card">
            <h1 class="component-page-title"><?php echo __('sec_history_title') ?? 'Historial de actividad'; ?></h1>
            <p class="component-page-description"><?php echo __('sec_history_desc') ?? 'Administra tu historial de búsqueda y reproducción de videos.'; ?></p>
        </div>
        ...
        <div class="component-toolbar">
            <div class="component-toolbar__tabs">
                <button type="button" class="component-toolbar__tab active" data-tab="watch-history">
                    ...
                    <?php echo __('tab_watch_history') ?? 'Historial de reproducción'; ?>
                </button>
                <button type="button" class="component-toolbar__tab" data-tab="search-history">
                    <span class="material-symbols-rounded">search</span>
                    <?php echo __('tab_search_history') ?? 'Historial de búsqueda'; ?>
                </button>
            </div>
            ...
            <div class="component-toolbar__actions">
                <button type="button" class="component-button component-button--danger-outline component-button--h36" id="btn-clear-history">
                    ...
                    <?php echo __('btn_clear_history') ?? 'Borrar historial'; ?>
                </button>
            </div>
        </div>

        <div id="watch-history-container" class="history-tab-content active">
