...
// Requerir la nueva clase Utils (Subimos api/services -> api -> raíz -> includes/core)
...
class AuthServices {
    ...
    public function register($data) {
        ...
        // Utilizamos el nuevo Utils estático para generar el UUID
        $uuid = Utils::generateUUID();
        $hashedPassword = password_hash($password, PASSWORD_BCRYPT);
        
        // Utilizamos el Utils estático para generar la foto de perfil en HD (512px)
