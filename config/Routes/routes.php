...
return [
    ...
    '/canvases/manage' => ['view' => 'canvases/core/manage.php', 'auth' => false, 'permissions' => [PC::MANAGE_CANVASES], 'requires_2fa' => false],
    ...
    '/canvases/edit/:uuid' => ['view' => 'canvases/workspace/edit.php', 'auth' => false, 'permissions' => [PC::MANAGE_CANVASES], 'requires_2fa' => false],
    ...
    '/canvases/members/:uuid/role/:user_uuid' => ['view' => 'canvases/team/change-role.php', 'auth' => true, 'permissions' => [PC::MANAGE_CANVASES], 'requires_2fa' => false],
    ...
    '/admin/user-roles/:uuid' => ['view' => 'admin/users/edit-user-role.php', 'auth' => true, 'permissions' => [PC::ASSIGN_ROLES], 'requires_2fa' => false],
