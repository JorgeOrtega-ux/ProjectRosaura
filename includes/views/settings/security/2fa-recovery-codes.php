            ...
            <div class="component-card--grouped active" data-ref="step-1-generate-codes">
                <div class="component-group-item component-group-item--stacked">
                    ...
                    <div class="component-card__actions component-card__actions--end">
                        ...
                        <button class="component-button component-button--primary component-button--h36" data-action="submitRegenerateRecoveryCodes"><?php echo __('btn_confirm'); ?></button>
                    </div>
                </div>
            </div>
            ...
            <div class="component-card--grouped disabled" data-ref="2fa-new-recovery-codes-wrapper">
                <div class="component-group-item component-group-item--stacked">
                    ...
                    <div class="component-card__actions component-card__actions--end">
                        ...
                        <button class="component-button component-button--primary component-button--h36" data-nav="<?php echo APP_URL; ?>/settings/2fa"><?php echo __('btn_finish'); ?></button>
                    </div>
                </div>
            </div>
