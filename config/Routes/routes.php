...
return [
    ...
    '/admin/edit-user-role' => ['view' => 'admin/users/edit-user-role.php', 'auth' => true, 'permissions' => [\App\Core\System\PermissionsConstants::ASSIGN_ROLES], 'requires_2fa' => false],
    ...
    '/admin/roles/edit' => ['view' => 'admin/roles/role-builder.php', 'auth' => true, 'permissions' => [\App\Core\System\PermissionsConstants::MANAGE_ROLES_STRUCTURE], 'requires_2fa' => false],
    '/admin/roles/permissions' => ['view' => 'admin/roles/role-permissions.php', 'auth' => true, 'permissions' => [\App\Core\System\PermissionsConstants::MANAGE_ROLES_STRUCTURE], 'requires_2fa' => false],
