...
function render_restoring_view() {
    ...
    $vIcons = file_exists(ROOT_PATH . '/public/assets/css/icons.css') ? filemtime(ROOT_PATH . '/public/assets/css/icons.css') : '1.0';
    $vRoot = file_exists(ROOT_PATH . '/public/assets/css/root.css') ? filemtime(ROOT_PATH . '/public/assets/css/root.css') : '1.0';
    $vStyles = file_exists(ROOT_PATH . '/public/assets/css/styles.css') ? filemtime(ROOT_PATH . '/public/assets/css/styles.css') : '1.0';
