...
export class SpaRouter {
    ...
    navigate(url) {
        let targetPath = url;
        try {
            // FIX 3: Limpiar origin si se mandó URL completa para que la validación no rebote y recargue ciegamente
    ...
    highlightCurrentRoute() {
        ...
        // FIX 2 y 3: Evaluar los paths correctamente, asegurándonos de extraer la ruta local si hay links con URL completas en data-nav.
        ...
        // FIX 2: Función genérica que aplicará el fallback (.active del grupo principal) 
